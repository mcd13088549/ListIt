package com.example.mmcke.listit;
...
public class NearbyFragment extends Fragment implements OnMapReadyCallback,
    ...
    //private final String GOOGLEAPI = getString(R.string.google_maps_key);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mapView = (MapView) view.findViewById(R.id.nearby_mapview);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnSupermarket = (Button) view.findViewById(R.id.btnSupermarket);
        btnSupermarket.setOnClickListener(new View.OnClickListener() {
            String Supermarket = "convenience_store";
            @Override
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyA7PgcnFP4arxoOaU7GK92g94DT327_Mwo");
